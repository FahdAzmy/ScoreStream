...
import SwiperCars from "../SwiperCars";
            ...
            card: (
              <div className=" w-full h-full relative">
                ...
                <CardInfo
                  ...
                  info="Last chance to pre-order and get access to additional premium content. Call of Duty®: Black Ops 6 launches on October 25th"
                  title="The truth lies"
                  src="/call-of-duty-black-ops-6-logo-01-en-21may24.webp"
                />
              </div>
            ),
            src: "/call-of-duty-black-ops-6-hero-desktop-01-en-21may24.webp",
            imgclasses: "object-right",
          },
          {
            card: (
              <div className=" flex items-start justify-start w-full h-full relative">
                ...
                <CardInfo
                  ...
                  info="Peter Parker & Miles Morales return for an exciting new adventure in the acclaimed Marvel’s Spider-Man franchise, out October 20 for PS5."
            ...
            card: (
              <div className=" w-full h-full relative">
                ...
                <CardInfo
                  ...
                  info="A legendary series has returned. Reach new levels of power in Dragon Ball: Sparking! Zero, out now on PS5"
                  title="Shake the earth. Break the universe !"
                  src="/Dragon-Ball-Sparking-Zero-logo-01-03oct24.webp"
                />
              </div>
            ),
            src: "/Dragon-Ball-Sparking-Zero-Hero-desktop-01-03oct24.webp",
            ...
            card: (
              <div className=" flex items-start justify-start w-full h-full relative">
                ...
                <CardInfo
                  ...
                  info="As cyber-enhanced mercenary V, join secret agent Solomon Reed to unravel a web of sinister political machinations."
